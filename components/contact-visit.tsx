...
const WHATSAPP_LINK = "https://wa.me/5592993514747?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20coleta.";
const MAPS_LINK = "https://maps.app.goo.gl/QCcnUrbxRMSV2CaG7";
    ...
    <section id="contato" className="relative bg-background pt-16 pb-0">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 mb-24">
        ...
        <div className="grid gap-6 sm:grid-cols-3 items-stretch">
          {/* Card: WhatsApp */}
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="group rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40 text-center flex h-full flex-col items-center justify-between">
            ...
            <p className="text-xs text-muted-foreground mt-1 px-4">Orçamentos, agendamentos e dúvidas.</p>
            <span className="text-primary font-bold mt-4 text-sm">(92) 98814-0239</span>
          </a>

          {/* Card Atualizado: Nossa Sede (Link Maps Interativo) */}
          <a href={MAPS_LINK} target="_blank" rel="noopener noreferrer" className="group rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40 text-center flex h-full flex-col items-center justify-between">
            <span className="flex size-12 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors mb-4">
            ...
            <span className="text-primary font-bold mt-4 text-sm group-hover:underline">Ver no Google Maps ➔</span>
          </a>

          {/* Card: Instagram */}
          <a href="https://instagram.com/amazonshoes.lavanderia" target="_blank" rel="noopener noreferrer" className="group rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/40 text-center flex h-full flex-col items-center justify-between">
            <span className="flex size-12 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors mb-4">
            ...
            <span className="rounded-full border border-border bg-secondary px-3 py-1 text-xs font-medium mt-4 text-primary group-hover:bg-primary/20 transition-colors">@amazonshoes.lavanderia</span>
          </a>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 items-stretch max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl border border-border bg-card p-5 flex flex-col justify-between">
              ...
              <div className="relative w-full aspect-[4/5] rounded-xl overflow-hidden border border-border">
                <Image 
                  src="/fachada.jpeg"
            ...
            <div className="rounded-2xl border border-border bg-card p-5 flex flex-col justify-between">
              ...
              <div className="relative w-full aspect-[4/5] rounded-xl overflow-hidden border border-border bg-background">
                <Image 
                  src="/horarios.jpeg" 
      ...
      <footer className="border-t border-border bg-card/60">
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex flex-col md:items-end gap-1">
            ...
            <a href="mailto:amz.shoes@hotmail.com" className="text-xs text-primary font-semibold flex items-center gap-1 hover:underline">
              <Mail className="size-3.5" /> amz.shoes@hotmail.com
            </a>
          </div>
        </div>
      </footer>
