...
const features = [
  {
    ...
    desc: "Nossa missão vai além de lavar tênis. É preservar materiais, valorizar cada detalhe e entregar um resultado que você vê, sente e confia.",
    tag: "01",
  },
  {
    icon: ShieldCheck,
    title: "cuidado artesanal",
    desc: "Cada tênis recebe o tratamento que o seu material exige. Camurça, couro, suede e outros materiais delicados são higienizados à mão para garantir uma limpeza segura, preservando a aparência, a textura e a durabilidade do calçado.",
    tag: "02",
  },
  {
    icon: Cpu,
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-balance text-3xl font-bold tracking-tight sm:text-5xl">
            <span className="text-foreground">Qualidade premium,</span>{' '}
            <span className="text-primary">cuidado artesanal e tecnologia avançada.</span>
          </h2>
        </div>
