        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 border-l-2 border-primary pl-4 italic text-muted-foreground text-base sm:text-lg">
              A <strong className="text-foreground font-semibold">Amazon Shoes Lavanderia</strong> não é apenas um serviço de limpeza; é uma extensão da paixão por calçados em Manaus. Nascemos para atender colecionadores, atletas e quem entende que um bom par de tênis conta uma história.
            </div>
            
            <p className="mt-6 text-pretty text-muted-foreground leading-relaxed">
              Inspirados pela imponência e vigor da nossa região Amazônica, trouxemos cores marcantes para a nossa identidade e um rigor técnico imbatível no tratamento de materiais sensíveis como camurça, couro nobuck e mesh tecnológico. Aqui, seu calçado recebe tratamento de arte.
            </p>
          </div>
