...
export function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-24 h-[420px] w-[620px] -translate-x-1/2 rounded-full bg-primary/10 blur-[140px] dark:bg-primary/20"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,oklch(0.72_0.22_130_/_0.08),transparent_60%)] dark:bg-[radial-gradient(circle_at_50%_120%,oklch(0.88_0.24_130_/_0.12),transparent_60%)]"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 text-center sm:px-8">
        ...
        <motion.h1
          ...
          className="mx-auto mt-6 max-w-4xl text-balance text-4xl font-bold leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl"
        >
          <span className="text-foreground">Genuinamente</span>{' '}
          <span className="text-primary">amazonense</span>
        </motion.h1>
        ...
        >
          "Qualidade premium, cuidado artesanal e tecnologia avançada para devolver o brilho dos seus pares favoritos. Buscamos e entregamos na sua porta."
        </motion.p>
