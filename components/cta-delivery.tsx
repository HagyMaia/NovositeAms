...
const WHATSAPP_LINK = "https://wa.me/5592988140239?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20o%20delivery.";

const perks = [
  { icon: Truck, label: "Delivery próprio", sub: "Seu patrimônio em boas mãos"},
  { icon: Clock, label: "Pronto em 48h", sub: "Válido para serviço pra hoje e pra ontem" },
