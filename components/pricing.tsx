...
const WHATSAPP = "https://wa.me/5592988140239?text=Ol%C3%A1!%20Quero%20agendar%20uma%20coleta%20Amazon%20Shoes"
...
export function Pricing() {
  ...
  const [activePlan, setActivePlan] = useState(defaultActivePlan)
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-balance text-3xl font-bold tracking-tight sm:text-5xl">
            ...
            <span className="text-primary">tratamento ideal</span>
          </h2>
          ...
          {plans.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                onMouseLeave={() => setActivePlan(defaultActivePlan)}
                className={`relative flex flex-col overflow-hidden rounded-3xl border p-8 transition-all duration-300 ${
                  isActive
                    ? "z-10 border-primary bg-card shadow-[0_0_90px_-20px_rgba(132,255,0,0.24)] scale-[1.02] lg:-mt-4 lg:mb-4"
                    : "border-border bg-card hover:border-primary/70 hover:shadow-[0_0_40px_-18px_oklch(0.72_0.22_130_/_0.15)]"
                }`}
              >
                {plan.featured && (
                ...
                <a
                  ...
                  className="mt-8 rounded-full bg-primary px-6 py-3.5 text-center text-sm font-semibold text-primary-foreground transition-transform hover:scale-105 hover:bg-primary/80"
                >
                  Agendar coleta
                </a>
              </motion.div>
